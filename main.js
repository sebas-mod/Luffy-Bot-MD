...
mobile: MethodMobile, 
browser: opcion == '1' ? [`luffy-Bot-MD`, 'Edge', '20.0.04'] : methodCodeQR ? [`Luffy-Bot-MD`, 'Edge', '20.0.04'] : ['Ubuntu', 'Chrome', '20.0.04'], 
auth: {
creds: state.creds,
...
_quickTest().then(() => conn.logger.info(chalk.bold(`☁️ HECHO\n`.trim()))).catch(console.error)
